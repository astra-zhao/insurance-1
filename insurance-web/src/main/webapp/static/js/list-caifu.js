				...
				if(data.code==200){
					...
					for(var i=0;i<data.rows.length;i++){
						...
						html += '<div class="pro-list">';
							html += '<p class="proname"><a href="detail.html?proId=' + cur.id + '&term=' + cur.term + '&price=' + cur.price+'">'+cur.productName+'</a></p>';
							html += '<div class="pro-list-bottom">';
								html += '<a href="detail.html?proId=' + cur.id + '&term=' + cur.term + '&price=' + cur.price+'">';
									html += '<i class="icon icon-tuijian"></i>';
									html += '<ul class="clearfix">';
										html += '<li>历史结算利率</li><li>最低持有期</li><li>起投金额</li>';
									html += '</ul>';
									html += '<ol class="clearfix">';
										html += '<li><span>'+0+'</span>%</li><li><span>'+cur.term+'</span>年</li><li><span>'+cur.price+'</span>元</li>';
									html += '</ol>';
								html +='</a>';
							html += '</div>';
						...
						/*
						 * <div class="pro-list">
               <p>宏康在线理财计划两全保险（投资连结型）</p>
               <div class="pro-list-bottom">
                   <i class="icon icon-tuijian"></i>
                   <ul class="clearfix">
                       <li>历史结算利率</li>
                       <li>最低持有期</li>
                       <li>起投金额</li>
