package com.mrbt.insurance.admin.commons.datasource;

import com.mrbt.insurance.admin.commons.annotation.DataSourceChange;
import com.mrbt.insurance.admin.commons.exception.DataSourceAspectException;
...
/**
 * 有{@link com.mrbt.insurance.admin.commons.annotation.DataSourceChange}注解的方法，调用时会切换到指定的数据源
 *
 * @author tanghd
 */
@Aspect
